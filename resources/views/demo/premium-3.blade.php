...
<body class="antialiased" style="overflow: hidden; background-color: rgb(180, 180, 180);">
    ...
    <section>
        <div id="cover-page"
            ...
            style="background-image: url('{{ asset('tema/premium-3/bg.png') }}'); 
    ...
    <section id="main-invitation">
        <div class="relative flex flex-col justify-center items-start min-h-screen w-full mx-auto max-w-[500px]"
            ...
            background-attachment: fixed;">
            <!-- Teks Pembuka -->
            <div class="text-black bg-white mt-8 p-8">
                <div class="text-3xl">
                    <div class="font-cormorant" data-aos="fade-right" data-aos-easing="ease-in-sine"
                        data-aos-duration="800">
                        We Are Getting
                    </div>
                    <div class="mt-1 font-dmSerifDisplay uppercase" data-aos="fade-left" data-aos-easing="ease-in-sine"
                        data-aos-duration="800">
                        Married!
                    </div>
                </div>
                <div class="text-sm mt-7 font-cormorant" data-aos="fade-up" data-aos-easing="ease-in-sine"
                    data-aos-duration="800">
                    <div class="text-2xl">
    ...
    <section>
        <div class="relative flex flex-col justify-center items-center min-h-screen max-w-[500px] mx-auto"
            ...
            background-attachment: fixed;">
            <!-- Countdown -->
            <div class="relative w-full my-10" data-aos="zoom-in" data-aos-easing="ease-in-sine"
                data-aos-duration="800">
                <div class="flex items-center justify-center text-center gap-4 w-full my-5">
                    <div class="h-[1px] bg-black flex-1"></div>
                ...
                <div id="countdown" class="text-center text-white flex justify-center space-x-5">
            ...
            <div class="bg-white relative w-full text-black flex">
                <div class="mx-7 w-full z-10">
                    <div class="px-5 my-10 text-center" data-aos="fade-up" data-aos-easing="ease-in-sine"
                        data-aos-duration="800">
    ...
    <section>
        <div class="text-black relative flex justify-center items-center w-full mx-auto max-w-[500px]">
            <div class="absolute z-10 text-center bg-white py-10 px-0 md:px-5 mx-5 mb-5 shadow-xl" data-aos="zoom-in"
                data-aos-easing="ease-in-sine" data-aos-duration="800">
        ...
        <div class="text-black relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
            ...
            <div class="flex flex-col">
                <div class="mt-72 md:mt-52 mb-10">
                    <!-- Judul -->
                    <div class="text-4xl uppercase font-dmSerifDisplay text-center mb-7 mt-10" data-aos="fade-down"
                        data-aos-easing="ease-in-sine" data-aos-duration="800">
                        Love Story
                    </div>
                    <!-- Divider -->
                    ...
                    <div class="my-5 mx-5">
                        ...
                        <div class="bg-white shadow-xl mt-5 mb-10" data-aos="fade-up" data-aos-easing="ease-in-sine"
                            data-aos-duration="800">
                            <div class="text-xl font-dmSerifDisplay p-4">
                                Lamaran
                            </div>
        ...
        <div
            ...
            <div class="flex flex-col my-24">
                ...
                <div class="text-center">
                    <h2 class="text-3xl font-dmSerifDisplay mb-5 mx-8" data-aos="fade-down"
                        data-aos-easing="ease-in-sine" data-aos-duration="800">
                        Wedding Wish
                    </h2>
                    <p class="mb-10 mx-8 font-cormorant text-lg" data-aos="fade-up" data-aos-easing="ease-in-sine"
                        data-aos-duration="800">
                ...
                <div class="px-4 mb-10 mt-5 mx-2"
                    style="max-height: 500px; overflow-y: auto; background-image: url('{{ asset('tema/premium-3/bg.png') }}'); 
                    background-position: center; 
                    background-size: cover; 
                    background-attachment: fixed;">
                    <div data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-duration="800">
                        ...
                        <div class="mb-4 p-5 bg-white rounded-lg shadow-xl">
                            <h4 class="uppercase font-dmSerifDisplay text-black">
                                Toni
                            </h4>
                            <p class="text-gray-600 font-cormorant text-lg pt-1">
    ...
    <section>
        <div class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
            ...
            background-attachment: fixed;">
            <div class="flex flex-col">
                <div class="my-10 bg-white py-10 mx-5 shadow-xl" data-aos="fade-up" data-aos-easing="ease-in-sine"
                    data-aos-duration="800">
                    <!-- Judul -->
                    ...
                    <div>
                        <div class="w-full text-center text-black mt-10">
                            ...
                            <p class="font-cormorant text-lg font-bold">BCA</p>
                            <p class="mt-4 font-cormorant text-lg">Atas Nama :</p>
                            <p class="font-cormorant text-lg font-bold">Rizky Syaputra</p>
                            <p class="mt-4 font-cormorant text-lg">Nomor Rekening :</p>
                            <p id="nomor_rekening_1" class="font-cormorant text-lg font-bold mb-4">
                                12345678910
                            </p>
                        ...
                        <div class="w-full text-center text-black">
                            ...
                            <p class="font-cormorant text-lg font-bold">BCA</p>
                            <p class="mt-4 font-cormorant text-lg">Atas Nama :</p>
                            <p class="font-cormorant text-lg font-bold">Ana Lutfiani</p>
                            <p class="mt-4 font-cormorant text-lg">Nomor Rekening :</p>
                            <p id="nomor_rekening_2" class="font-cormorant text-lg font-bold mb-4">
                                10987654321
                            </p>
                            <div class="mb-4 text-center">
    ...
    <div class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
        ...
        background-attachment: fixed;">
        <!-- Konten -->
        <div class="flex flex-col text-center text-black bg-white py-10 px-5 mx-5 shadow-xl">
            <div class="my-5">
                <!-- Teks Penutup -->
