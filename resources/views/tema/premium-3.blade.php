                ...
                <div class="flex flex-col mt-10 mb-72 md:mb-52">
                    ...
                    <div class="mx-5">
                        ...
                        <div class="mb-20">
                                ...
                                <div class="grid grid-cols-2 gap-4 py-5">
                                    @foreach (json_decode($invitation->galeri->foto_galeri) as $foto)
                                        <img src="{{ asset(str_replace('D:/Herd/undangan/public/', '', $foto)) }}"
                                            alt="Foto"
                                            class="w-full aspect-square object-cover rounded cursor-pointer shadow-xl"
                            ...
                            @else
                                <p class="text-center text-black p-5" data-aos="zoom-in"
                                    data-aos-easing="ease-in-sine" data-aos-duration="800">Tidak ada foto galeri</p>
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <div class="text-black relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
            ...
            <div class="flex flex-col">
                <div class="mt-72 md:mt-52 mb-10">
                    <!-- Judul -->
                    <div class="text-4xl uppercase font-dmSerifDisplay text-center mb-7 mt-20" data-aos="fade-down"
                        data-aos-easing="ease-in-sine" data-aos-duration="800">
                        Love Story
                    </div>
                    <!-- Divider -->
                    ...
                    <!-- Cerita -->
                    <div>
                        @if (!empty($invitation->cerita) && $invitation->cerita->isNotEmpty())
                            ...
                            @endforeach
                        @else
                            <p class="text-center text-red-600 font-cormorant text-lg font-bold mt-4">
            ...
            <div class="flex flex-col my-24">
                ...
                @if ($commentsEnabled)
                    ...
                    <div class="text-center">
                        ...
                        <p class="mb-10 mx-8 font-cormorant text-lg" data-aos="fade-up"
                            data-aos-easing="ease-in-sine" data-aos-duration="800">
    ...
    <div class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
        ...
        <div class="flex flex-col text-center text-black bg-white py-10 px-5 mx-5 shadow-xl">
            <div class="my-5">
                <!-- Teks Penutup -->
                <div>
                    <div class="font-cormorant text-lg" data-aos="fade-right" data-aos-easing="ease-in-sine"
                        data-aos-duration="800">
                    ...
                    <div class="font-dmSerifDisplay mt-5" data-aos="fade-left" data-aos-easing="ease-in-sine"
                        data-aos-duration="800">
                ...
                <div>
                    ...
                    <div class="text-2xl font-bold mt-3 font-dmSerifDisplay" data-aos="fade-left"
                        data-aos-easing="ease-in-sine" data-aos-duration="800">
                        @if ($invitation->mempelai)
                            {{ $invitation->mempelai->panggilan_pria ?? '-' }}
                            &
